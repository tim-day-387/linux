...
/* #undef HAVE_ILOOKUP5_NOWAIT_ISNEW */
...
#define HAVE_KILL_LITTER_SUPER 1
...
#define HAVE_NETDEV_CMD_TO_NAME 1
...
/* (external) 'ib_alloc_fast_reg_mr' exists */
/* #undef HAVE_OFED_IB_ALLOC_FAST_REG_MR */

/* (external) 2arg 'ib_alloc_pd' exists */
/* #undef HAVE_OFED_IB_ALLOC_PD_2ARGS */

/* (external) 'struct ib_cq_init_attr' is used by ib_create_cq */
/* #undef HAVE_OFED_IB_CQ_INIT_ATTR */

/* (external) 'struct ib_device' has member 'attrs' */
/* #undef HAVE_OFED_IB_DEVICE_ATTRS */
...
/* (external) function 'ib_inc_rkey' is defined */
/* #undef HAVE_OFED_IB_INC_RKEY */

/* (external) struct ib_reg_wr exists */
/* #undef HAVE_OFED_IB_MAP_MR_SG */

/* (external) 'ib_map_mr_sg()' with 5 args exists */
/* #undef HAVE_OFED_IB_MAP_MR_SG_5ARGS */

/* (external) 'ib_post_send() and ib_post_recv()' have const parameters */
/* #undef HAVE_OFED_IB_POST_SEND_RECV_CONST */

/* (external) 'struct ib_rdma_wr' is defined */
/* #undef HAVE_OFED_IB_RDMA_WR */
...
/* (external) 'rdma_create_id' wants four args */
/* #undef HAVE_OFED_RDMA_CREATE_ID_4ARG */

/* (external) 'rdma_create_id' wants five args */
/* #undef HAVE_OFED_RDMA_CREATE_ID_5ARG */
...
/* #undef HAVE_POSIX_ACL_TO_XATTR_ALLOC_BUFFER */
...
/* #undef HAVE_STRUCT_SOCKADDR_UNSIZED */
...
/* #undef HAVE_VFS_CREATE_DELEGATE */

/* vfs_mkdir() takes delegate */
/* #undef HAVE_VFS_MKDIR_DELEGATE */
...
/* (in kernel) 'ib_alloc_fast_reg_mr' exists */
/* #undef IN_KERNEL_HAVE_OFED_IB_ALLOC_FAST_REG_MR */

/* (in kernel) 2arg 'ib_alloc_pd' exists */
/* #undef IN_KERNEL_HAVE_OFED_IB_ALLOC_PD_2ARGS */

/* (in kernel) 'struct ib_cq_init_attr' is used by ib_create_cq */
/* #undef IN_KERNEL_HAVE_OFED_IB_CQ_INIT_ATTR */

/* (in kernel) 'struct ib_device' has member 'attrs' */
/* #undef IN_KERNEL_HAVE_OFED_IB_DEVICE_ATTRS */
...
/* (in kernel) function 'ib_inc_rkey' is defined */
/* #undef IN_KERNEL_HAVE_OFED_IB_INC_RKEY */

/* (in kernel) struct ib_reg_wr exists */
/* #undef IN_KERNEL_HAVE_OFED_IB_MAP_MR_SG */

/* (in kernel) 'ib_map_mr_sg()' with 5 args exists */
/* #undef IN_KERNEL_HAVE_OFED_IB_MAP_MR_SG_5ARGS */

/* (in kernel) 'ib_post_send() and ib_post_recv()' have const parameters */
/* #undef IN_KERNEL_HAVE_OFED_IB_POST_SEND_RECV_CONST */

/* (in kernel) 'struct ib_rdma_wr' is defined */
/* #undef IN_KERNEL_HAVE_OFED_IB_RDMA_WR */
...
/* (in kernel) 'rdma_create_id' wants four args */
/* #undef IN_KERNEL_HAVE_OFED_RDMA_CREATE_ID_4ARG */

/* (in kernel) 'rdma_create_id' wants five args */
/* #undef IN_KERNEL_HAVE_OFED_RDMA_CREATE_ID_5ARG */
...
#define PACKAGE_STRING "Lustre 2.17.52_131_g5f385e0_dirty"
...
#define PACKAGE_VERSION "2.17.52_131_g5f385e0_dirty"
...
#define VERSION "2.17.52_131_g5f385e0_dirty"
...
#define old_posix_acl_to_xattr(ns, acl, buf, sz) posix_acl_to_xattr(ns, acl, buf, sz)
...
#define HAVE_ZFS_ARC_PRUNE_FUNC_UINT64
